...
[https://nmrium.nmrxiv.org/releases/v1.0.0](https://nmrium.nmrxiv.org/releases/v1.0.0) -> [v1.0.0](https://github.com/NFDI4Chem/nmrium-react-wrapper/releases/tag/v1.0.0)
...
|:----           |:---                          | :----                        | :----            |
|        [Latest-stable](https://github.com/NFDI4Chem/nmrium-react-wrapper/releases/tag/v1.0.0)           |     [v0.41.0](https://github.com/cheminfo/nmrium/releases/tag/v0.41.0)    |      [v4](/public/data/Data%20Schema%20Versions/V4/)                  |   [Migration script](https://github.com/cheminfo/nmr-load-save/blob/master/src/migration/migrateToVersion3.ts) |
